  ...
  const handleSave = async (reloadAfterSave = true) => {
    try {
      const updatedData = matches.map((match, index) => ({
        ...
        date: document.getElementById(`date-${index}`).value || null,
        session_time: document.getElementById(`session_time-${index}`).value || null,
        venue: document.getElementById(`venue-${index}`).value || null,
        table: document.getElementById(`table-${index}`).value || null,
      }));
